...
GitHub StarLists++ 把 GitHub starred lists 从“被动归档”变成“主动整理”的工作流。
...
- [为什么做 GitHub StarLists++](#为什么做-github-starlists)
- [核心亮点](#核心亮点)
- [支持运行形态](#支持运行形态)
- [配置方式](#配置方式)
- [兼容矩阵](#兼容矩阵)
...
- 支持按 Star 时间排序
- 支持批量选择、批量加入 / 移出 lists 和批量取消 Star
...
项目不接入外部分析服务、没有远端跟踪，也没有单独的 GitHub StarLists++ 后端。如果你填写 GitHub token，它只会保存在本地扩展存储或 userscript 管理器存储中，并且仅用于 GitHub API 请求。
